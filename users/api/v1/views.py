...
from users.constants import MAX_PROFILE_PIC_UPLOAD_SIZE
...
class ConfirmDeletionView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            user.username = f"deleted_user_{original_username}"
...
class ContactUsView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            date_time_submitted = timezone.now().strftime("%Y-%m-%d %H:%M:%S")

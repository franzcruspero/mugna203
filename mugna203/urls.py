...
api_info = openapi.Info(
    title="mugna203 API",
    default_version="v1",
    description="API documentation for mugna203",
)
...
admin.site.site_header = "mugna203"
admin.site.site_title = "mugna203 Admin Portal"
admin.site.index_title = "mugna203 Admin"
